...
#ifndef _GxCTRL_ILI9488_H_
#define _GxCTRL_ILI9488_H_

#include "../GxCTRL.h"

class GxCTRL_ILI9488 : public GxCTRL
{
  public:
    GxCTRL_ILI9488(GxIO& io) : GxCTRL(io) {};
    const char* name = "GxCTRL_ILI9488";
...
#define GxCTRL_Class GxCTRL_ILI9488
